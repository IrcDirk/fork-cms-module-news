    ...
    private function upload($file)
    {
        ...
        if ($file_data) {
            ...
            if (filesize($temp_file) > 0) {
                ...
                $insert['news_post_id'] = $this->id;
                $insert['data'] = serialize(array());

                $insert['sequence'] = BackendNewsImagesModel::getMaximumSequence($this->id) + 1;
                $insert['hidden'] = 'N';

                //BackendNewsHelper::generateThumbnail($filename, $files_path, $preview_files_path);
                ...
                $insert['id'] = BackendNewsImagesModel::insert($insert);
                ...
                foreach ($this->languages as $language) {
                 ...
                 // insert it
               BackendNewsImagesModel::insertContent($content);
