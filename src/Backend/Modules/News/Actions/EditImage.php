...
class EditImage extends ActionEdit
{
    ...
    protected function loadData()
    {
        ...
        $this->record = BackendNewsImagesModel::get($this->id);
        ...
        if ($this->frm->isSubmitted()) {
            ...
            if ($this->frm->isCorrect()) {
                ...
                foreach($this->languages as $language)
                {
                    ...
                    $specific['url'] =  BackendNewsImagesModel::getURL(CommonUri::getUrl($specific['name']), $language['abbreviation'], $item['id']);
                ...
                BackendNewsImagesModel::updateContent($content, $item['id'] );
