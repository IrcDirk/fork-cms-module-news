...
class Settings extends BackendBaseActionEdit
{
    ...
    private function loadForm()
    {
        ...
        $this->frm->addCheckbox(
            'make_widget_per_news_post',
            $this->get('fork.settings')->get($this->getModule(), 'make_widget_per_news_post', false)
        );
        ...
        if ($this->frm->isSubmitted()) {
            if ($this->frm->isCorrect()) {
                ...
                $this->get('fork.settings')->set(
                    $this->getModule(),
                    'make_widget_per_news_post',
                    (bool) $this->frm->getField('make_widget_per_news_post')->getValue()
                );
